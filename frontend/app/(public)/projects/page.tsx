        ...
        <div className="flex items-center gap-2 bg-slate-200 p-1 rounded-lg text-xs font-semibold">
          <button
            ...
            className={`px-3 py-1.5 rounded-md transition ${
              filterFeatured === undefined ? "bg-white text-slate-900 shadow-xs" : "text-slate-600 hover:text-slate-900"
            }`}
          >
          ...
          <button
            ...
            className={`px-3 py-1.5 rounded-md transition ${
              filterFeatured === true ? "bg-white text-blue-600 shadow-xs" : "text-slate-600 hover:text-slate-900"
            }`}
          >
            ...
            >
              <div className="space-y-3">
                ...
                {proj.translation?.role && (
                  <p className="text-xs font-semibold text-blue-600">👤 {proj.translation.role}</p>
                )}
                ...
                {proj.translation?.description && (
                  <p className="text-xs text-slate-600 leading-relaxed">{proj.translation.description}</p>
                )}
